...
class New_ConvolutionalProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(New_ConvolutionalProcessingBlock, self).__init__()
...
class New_ConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(New_ConvolutionalDimensionalityReductionBlock, self).__init__()
