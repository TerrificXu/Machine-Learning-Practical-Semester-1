...
elif args.block_type == 'new_conv_block':
    processing_block_type = New_ConvolutionalProcessingBlock
    dim_reduction_block_type = New_ConvolutionalDimensionalityReductionBlock
else:
